...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('auths/modules/bootstrap-social/bootstrap-social.css')}}">
                ...
                <div class="row">
                    <div
                        ...
                        <div class="mt-5 text-muted text-center">
                            Don't have an account? <a href="{{route('auth.register.create')}}">Create One</a>
                        </div>
